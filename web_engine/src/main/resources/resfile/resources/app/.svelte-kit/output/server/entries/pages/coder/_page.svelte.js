            ...
            SubMenu($$renderer4, {
              ...
              children: ($$renderer5) => {
                ...
                Item($$renderer5, {
                  ...
                  icon: `/icons/btn-send${current2.pages[current2.tab]?.pilotMode ? "pilot" : "run"}.svg`,
                ...
                $$renderer5.push(`<!----> `);
                Item($$renderer5, {
                  label: `${current2.pages[current2.tab]?.pilotMode ? "Pilot" : "Run"} in Python`,
                  icon: `/icons/btn-${current2.pages[current2.tab]?.pilotMode?.pilotMode ? "pilot" : "run"}py.svg`,
        ...
        children: ($$renderer4) => {
          ...
          Section($$renderer4, {
            ...
            children: ($$renderer5) => {
              ...
              SwitchButton($$renderer5, {
                labels: ["Pilot", "Run"],
                tooltip: `Experiment will run in ${current2.pages[current2.tab]?.pilotMode ? "pilot" : "run"} mode`,
                get value() {
                  return bind_get();
                },
                set value($$value) {
          ...
          if (python?.ready) {
            ...
            Section($$renderer4, {
              ...
              children: ($$renderer5) => {
                IconButton($$renderer5, {
                  icon: `/icons/btn-${current2.pages[current2.tab]?.pilotMode ? "pilot" : "run"}py.svg`,
                  label: `${current2.pages[current2.tab]?.pilotMode ? "Pilot" : "Run"} experiment locally`,
                  onclick: (evt) => runPython(),
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (current.pages.length === 0 && store.generatedCode.experimentJSON) {
      let label = "Experiment (from Builder)";
