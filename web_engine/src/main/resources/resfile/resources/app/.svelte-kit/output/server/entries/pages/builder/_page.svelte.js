            ...
            SubMenu($$renderer4, {
              ...
              children: ($$renderer5) => {
                ...
                Item($$renderer5, {
                  ...
                  icon: `/icons/btn-send${current2.experiment.pilotMode ? "pilot" : "run"}.svg`,
                ...
                $$renderer5.push(`<!----> `);
                Item($$renderer5, {
                  label: `${current2.experiment.pilotMode ? "Pilot" : "Run"} in Python`,
                  icon: `/icons/btn-${current2.experiment.pilotMode ? "pilot" : "run"}py.svg`,
                ...
                $$renderer5.push(`<!----> `);
                Item($$renderer5, {
                  label: `${current2.experiment.pilotMode ? "Pilot" : "Run"} in browser`,
                  icon: `/icons/btn-${current2.experiment.pilotMode ? "pilot" : "run"}js.svg`,
                  onclick: (evt) => runJS(),
                  shortcut: "runJS",
                  disabled: current2.experiment === null
                });
        ...
        children: ($$renderer4) => {
          ...
          Section$1($$renderer4, {
            ...
            children: ($$renderer5) => {
              ...
              SwitchButton($$renderer5, {
                labels: ["Pilot", "Run"],
                tooltip: `Experiment will run in ${current2.experiment.pilotMode ? "pilot" : "run"} mode`,
                get value() {
                  return bind_get();
                },
                set value($$value) {
          ...
          if (python?.ready) {
            ...
            Section$1($$renderer4, {
              ...
              children: ($$renderer5) => {
                ...
                IconButton($$renderer5, {
                  icon: `/icons/btn-${current2.experiment.pilotMode ? "pilot" : "run"}py.svg`,
                  label: `${current2.experiment.pilotMode ? "Pilot" : "Run"} experiment locally`,
                  onclick: (evt) => runPython(),
                  disabled: !current2.experiment.file.file,
          ...
          Section$1($$renderer4, {
            ...
            children: ($$renderer5) => {
              ...
              IconButton($$renderer5, {
                icon: `/icons/btn-${current2.experiment.pilotMode ? "pilot" : "run"}js.svg`,
                label: `${current2.experiment.pilotMode ? "Pilot" : "Run"} experiment in browser`,
                onclick: (evt) => runJS(),
                disabled: !current2.experiment.file.file,
                borderless: true,
                get awaiting() {
...
function EntryPoint$1($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let hovered = false;
    let moving = derived(() => current2.moving && [Component$1].includes(current2.moving.constructor));
    let inserting = derived(() => current2.inserting && [Component$1].includes(current2.inserting.constructor));
            ...
            for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
              ...
              Page($$renderer4, {
                ...
                children: ($$renderer5) => {
                  ...
                  } else if (current2.experiment.routines[name] instanceof StandaloneRoutine) {
                    $$renderer5.push("<!--[1-->");
...
function ComponentButton($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let btnsDisabled = derived(() => ({ OK: !valid(), APPLY: !valid() }));
    let $$settled = true;
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      if (!component.hidden) {
...
function EntryPoint($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let hovered = false;
    let moving = derived(() => current2.moving && [Routine$1, StandaloneRoutine, LoopInitiator, LoopTerminator].includes(current2.moving.constructor));
    let inserting = derived(() => current2.inserting && [Routine$1, StandaloneRoutine, LoopInitiator, LoopTerminator].includes(current2.inserting.constructor));
    ...
    function $$render_inner($$renderer3) {
      ...
      $$renderer3.push(`<!--]--> `);
      {
        ...
        Frame($$renderer3, {
          ...
          $$slots: { ribbon: true, default: true }
        });
      }
      $$renderer3.push(`<!---->`);
    }
