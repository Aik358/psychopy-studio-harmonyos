import { g as getContext, f as ensure_array_like, e as escape_html, a as attr, s as stringify, i as attr_style, c as bind_props, b as await_block, j as setContext } from "../../../chunks/root.js";
import "clsx";
import { d as CompactButton, a0 as Experiment, _ as Script, a1 as RadioButton, B as Button, C as CodeOutput, g as Menu, h as SubMenu, I as Item, S as Separator, s as showWindow, i as showDevTools, j as setupPython, V as Version, P as PrefsDialog, m as BugReport, r as Ribbon, t as Section, G as Gap, u as IconButton, v as SwitchButton, o as openIn, U as UserCtrl, J as Frame, K as Pane_group, O as Pane, Q as Panel$1, W as Pane_resizer, X as TipsDialog, Y as Shortcuts, Z as SetupPython, N as Notebook, q as Page } from "../../../chunks/TipsDialog.js";
  ...
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      ...
      for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
        ...
        Icon($$renderer3, { src: `/icons/btn-${item.pilotMode ? "pilot" : "run"}py.svg` });
        $$renderer3.push(`<!----> `);
          ...
          if (electron) {
            ...
            SubMenu($$renderer4, {
              ...
              children: ($$renderer5) => {
                ...
                $$renderer5.push(`<!----> `);
                Item($$renderer5, {
                  label: `${current2.runlist[current2.selection]?.pilotMode ? "Pilot" : "Run"} in Python`,
                  icon: `/icons/btn-${current2.runlist[current2.selection]?.pilotMode ? "pilot" : "run"}py.svg`,
                ...
                $$renderer5.push(`<!----> `);
                Item($$renderer5, {
                  label: `${current2.runlist[current2.selection]?.pilotMode ? "Pilot" : "Run"} in browser`,
                  icon: `/icons/btn-${current2.runlist[current2.selection]?.pilotMode ? "pilot" : "run"}js.svg`,
          ...
          Section($$renderer4, {
            ...
            children: ($$renderer5) => {
              ...
              SwitchButton($$renderer5, {
                labels: ["Pilot", "Run"],
                tooltip: `Experiment will run in ${current2.runlist[current2.selection]?.pilotMode ? "pilot" : "run"} mode`,
                get value() {
                  return bind_get();
                },
                set value($$value) {
              ...
              $$renderer5.push(`<!----> `);
              IconButton($$renderer5, {
                icon: `/icons/btn-send${current2.runlist[current2.selection]?.file.ext === ".psyexp" ? "builder" : "coder"}.svg`,
                label: `Open selection in ${current2.runlist[current2.selection]?.file.ext === ".psyexp" ? "Builder" : "Coder"}`,
          ...
          Section($$renderer4, {
            ...
            children: ($$renderer5) => {
              if (python?.ready) {
                ...
                IconButton($$renderer5, {
                  icon: `/icons/btn-${current2.runlist[current2.selection]?.pilotMode ? "pilot" : "run"}py.svg`,
                  label: `${current2.runlist[current2.selection]?.pilotMode ? "Pilot" : "Run"} experiment locally`,
              ...
              IconButton($$renderer5, {
                icon: `/icons/btn-${current2.runlist[current2.selection]?.pilotMode ? "pilot" : "run"}js.svg`,
                label: `${current2.runlist[current2.selection]?.pilotMode ? "Pilot" : "Run"} experiment in browser`,
