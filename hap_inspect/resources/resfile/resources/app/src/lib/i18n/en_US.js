// English (source language) translation dictionary for PsychoPy Studio OH.
// Keys are semantic; the Chinese dictionary (zh_CN.js) overrides a subset.
// Any key missing from zh_CN falls back to this file, then to the raw key.
...
export default {
    ...
    // ---- SwitchButton (Pilot/Run) tooltips ----
    ...
    // ---- Builder canvas structural labels (Routine / Component / Flow / Loop) ----
